...
//        return C.file.txapp_aliaccount+account.getIdentify()+".txt";
    ...
    public static List<Account> getAccount() {
        ...
        list.add(new Account("13468006640", "李琦",  "liqi123456","68f691e12a5a6827","男","13468006640", "李琦",  true));
        list.add(new Account("15588591960", "辛忠",  "xin03531883","a25b24b851b43890","男","15588591960", "辛忠",  true));
        list.add(new Account("13047488791", "霍彬彬", "hbb8791", "a72af041a8b6be33","男","13153870185", "辛子财",true));
        list.add(new Account("15764125171", "霍彬彬", "rich1990", "4782124a207df377","女","17864872607", "邱士菊",true));
        list.add(new Account("15665851629", "霍彬彬",  "shanshan0330","6d89828bd6001ddb","女","15665851629", "霍彬彬",  true));
